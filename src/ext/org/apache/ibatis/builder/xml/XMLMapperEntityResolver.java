...
public class XMLMapperEntityResolver implements EntityResolver {
  ...
  private static final String MYBATIS_CUSTOM_MAPPER_DOCTYPE = "-//mybatis.org//DTD Mapper 3.0//A2M".toUpperCase(Locale.ENGLISH);
  private static final String MYBATIS_CUSTOM_MAPPER_URL = "mybatis-3-config.dtd".toUpperCase(Locale.ENGLISH);
  ...
  static {
    ...
    doctypeMap.put(MYBATIS_CUSTOM_MAPPER_URL, IBATIS_MAPPER_DTD);
    doctypeMap.put(MYBATIS_CUSTOM_MAPPER_DOCTYPE, IBATIS_MAPPER_DTD);
  }
