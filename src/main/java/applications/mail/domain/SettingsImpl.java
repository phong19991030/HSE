...
//    @Autowired
//    public SettingsImpl(MailConfiguration mailConfiguration) {
//		imapServer = mailConfiguration.imapHost;
//		imapPort = mailConfiguration.getImapPort();
//		imapSecure = mailConfiguration.getIsSupportSSL() || mailConfiguration.getIsSupprotTLS();
//		smptServer = mailConfiguration.smtpHost;
//		smtpPort = mailConfiguration.getSmtpPort();
//		smtpSecure = mailConfiguration.getIsSupportSSL() || mailConfiguration.getIsSupprotTLS();
//	}
