...
package applications.mail.util;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

import applications.mail.domain.SConsts;
...
public class RegexPatterns {
    ...
    public static final Pattern regex_mailQueueStatus = Pattern.compile("\\{(\\d+)\\}");
    
    public static String extractValue(String s, Pattern pattern, int groupIndex) {
