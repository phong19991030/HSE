...
public class SessionBinding  implements HttpSessionBindingListener,Serializable{
	...
	public void valueBound(HttpSessionBindingEvent event){
		...
		SessionModelStateMng.getInstance().setSession(httpSession);		
//		try{
