...
@Controller
@RequestMapping(value = "/res/res_0003")
public class Res_0003Controller extends BaseController{

	@Autowired
	private Res_0003ServiceImpl service;
	...
	public ModelAndView list(ModelAndView mav, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		mav.setViewName("res/res_0003");
		mav.addObject("DATA", parameter);
		
		//hazardousCds option 
    	Map<Object, Object> tmp = new HashMap<Object, Object>();
    	tmp.put("COMM_CD", "HAZARDOUS_TYPE"); 
    	List<Map<Object, Object>> hazardousCds = sys_1100ServiceImpl.getComCodeListByComm_Cd(tmp);    	
    	mav.addObject("hazardousCds", hazardousCds);
    	
    	//storageCds option 
    	Map<Object, Object> tmp2 = new HashMap<Object, Object>();
    	tmp2.put("COMM_CD", "STORAGE_PLAN"); 
    	List<Map<Object, Object>> storageCds = sys_1100ServiceImpl.getComCodeListByComm_Cd(tmp2);    	
    	mav.addObject("storageCds", storageCds);
		return mav;
	}
	...
	public ModelAndView save(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
        ...
        map.put("HAZARDOUS_ID", parameter.get("HAZARDOUS_ID"));
	...
	public ModelAndView detailForm(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
		...
		mav.setViewName("res/res_000302");
	...
	public ModelAndView modifyForm(ModelAndView mav, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		mav.addObject("DATA", parameter);
		mav.setViewName("res/res_000301");
	...
	@RequestMapping("/deleteHazardousFile.ajax")
	public ModelAndView deleteHazardousFile(ModelAndView mav, HttpServletRequest request) throws Exception {
		Map<Object, Object> parameter = ParameterUtil.getParameterMap(request);
		int result = service.deleteHazardousFile(parameter);
