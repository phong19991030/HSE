...
@Controller("Code_0103Controller")
@RequestMapping("/sys/sys_0103")
public class Code_0103Controller extends BaseController {
	...
	public ModelAndView doList(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
		 ...
		 * ModelAndView
		 */
		mav.setViewName("sys/sys_0103");
		return mav;
	}

	@RequestMapping("/getCommonCode.ajax")
	...
	/*
	 * @RequestMapping("/getMaintanceCode.ajax") public @ResponseBody List
	 * getData03(ModelAndView mav, HttpServletRequest request, HttpServletResponse
	 * response) throws Exception { Map<String, Object> parameter =
	 * ParameterUtil.getParameterMap(request); List list =
	 * service.getMaintainceCode(parameter); List listMainten =
	 * service.convertListToTree(list); return listMainten; }
	 */
	...
	public ModelAndView getData04(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public ModelAndView getAllData(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		parameter.put("TYPE", "004");
		List list = service.getGroupAlarmCode(parameter);
		/**
		 * ModelAndView
		 */
		mav.setViewName("jsonView");
	...
	public ModelAndView getAllDetailCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map parameter = ParameterUtil.getParameterMapWithOutSession(request);
		Map search = (Map) parameter.get("search");
		parameter.putAll(search);
	...
	public @ResponseBody boolean checkDoubleCode(ModelAndView mav, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Map parameter = ParameterUtil.getParameterMap(request);
		String newCode = (String) parameter.get("COMM_CD");
		List listCode = service.getCommonCode(parameter);
		boolean check = service.checkDoubleCode(parameter, listCode);
		return check;
	}
	...
	public ModelAndView createCommon(ModelAndView mav, HttpServletRequest request, HttpServletResponse response,
		...
		Map parameter = ParameterUtil.getParameterMap(request);
		mav.setViewName(path + ":sys/sys_010301");
		return mav;
	}
	...
	public ModelAndView saveManual(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
...
//	}
	...
	public ModelAndView adddDetailAlarm(ModelAndView mav, HttpServletRequest request, HttpServletResponse response,
		...
		Map alarmGroup = (Map) service.getAlarmGroupById(parameter);
		if (crud.equals("U")) {
			Map alarm = (Map) service.getAlarmCodeDetailById(parameter);
			parameter.putAll(alarm);
	...
	public @ResponseBody boolean addCommonCode(ModelAndView mav, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
		String CRUD = (String) parameter.get("CRUD");
		boolean check = true;
		if (CRUD.equals("C")) {
			String newCode = (String) parameter.get("COMM_CD");
			List listCode = service.getCommonCode(parameter);
			check = service.checkDoubleCode(parameter, listCode);
			if (check) {
	...
	public ModelAndView addMaintenCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
		String CRUD = (String) parameter.get("CRUD");
		if (CRUD.equals("C")) {
	...
	public ModelAndView addPartCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
		String CRUD = (String) parameter.get("CRUD");
		if (CRUD.equals("C")) {
	...
	public ModelAndView deleteMaintenCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
		List list = service.getMaintainceCode(parameter);
	...
	public ModelAndView deletePartCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
		List list = service.getPartCode(parameter);
		List result = service.getAllChildId(list, parameter);
	...
	public ModelAndView deleteCommonCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
		List list = service.getCommonCode(parameter);
		List result = service.getAllChildId(list, parameter);
	...
	/*
	 * @RequestMapping("/addAlarmCode.ajax") public ModelAndView
	 * addAlarmCode(ModelAndView mav, HttpServletRequest request,
	 * HttpServletResponse response) throws Exception { Map<String, Object>
	 * parameter = ParameterUtil.getParameterMap(request);
	 * service.insertAlarmCode(parameter); mav.setViewName("jsonView");
	 * mav.addObject("result",parameter); return mav; }
	 */
	@RequestMapping("/addAlarmCode.ajax")
	public @ResponseBody Map addAlarmCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map parameter = ParameterUtil.getParameterMap(request);
		Map session = (Map) parameter.get("session");
		boolean check = true;
	...
	@RequestMapping("/updateAlarmCode.ajax")
	public @ResponseBody Map updateAlarmCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map parameter = ParameterUtil.getParameterMap(request);
		Map session = (Map) parameter.get("session");
		boolean check = true;
		check = service.checkAlarmCodeUpdate(parameter);
		if (check) {
			parameter.putAll(session);

			service.updateAlarmCode(parameter);
		}
		parameter.put("CHECK", check);
		return parameter;
	}
	...
	public @ResponseBody boolean checkDoubleAlarmCode(ModelAndView mav, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Map parameter = ParameterUtil.getParameterMap(request);
	...
	@RequestMapping("/checkDoubleAlarmCodeUpdate.ajax")
	public @ResponseBody boolean checkDoubleAlarmCodeUpdate(ModelAndView mav, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Map parameter = ParameterUtil.getParameterMap(request);
		boolean check = service.checkAlarmCodeUpdate(parameter);
		return check;
	}

	@RequestMapping("/saveDetailAlarm.ajax")
	public @ResponseBody Map saveDetailAlarm(ModelAndView mav, HttpServletRequest request,
		...
		String userUid = CommonUtil.getMapValue(session, "USER_UID", "");
		AjaxResult result = new AjaxResult();
		List<MultipartFile> fileList = parameter.get("file") == null ? null
				: (List<MultipartFile>) parameter.get("file");
	...
	public ModelAndView deleteSubAlarmCd(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
		service.deleteSomeAlarm(parameter);
	...
	@RequestMapping("/deleteGrAlarmCd.ajax")
	public ModelAndView deleteGrAlarmCd(ModelAndView mav, HttpServletRequest request, HttpServletResponse response) {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
//		service.deleteSomeAlarm(parameter);
//		service.deleteSubAlarmCd(parameter);
		String rs = "true";
		try {
			service.deleteGroupAlarmCode(parameter);
		} catch (Exception e) {
	...
	public @ResponseBody boolean checkDoubleAlarmDetail(ModelAndView mav, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Map parameter = ParameterUtil.getParameterMap(request);
		String newCode = (String) parameter.get("ALARM_SUB_CD");
		String alarmCd = (String) parameter.get("WT_ALARM_GR_ID");
	...
	public ModelAndView getPartDetailCd(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		Map parameter = ParameterUtil.getParameterMapWithOutSession(request);
	...
	@RequestMapping("/formdetail/form.{path}") // path = [popup,dialog,tab]
	public ModelAndView detailAlarm(ModelAndView mav, HttpServletRequest request, HttpServletResponse response,
			@PathVariable String path) throws Exception {

		Map parameter = ParameterUtil.getParameterMap(request);
//		String code = (String) parameter.get("CODE");
		Map alarm_gr = (Map) codeDao.object("getGroupAlarmById", parameter);

		mav.addObject("DATA", alarm_gr);
		mav.setViewName(path + ":sys/sys_010302");
		return mav;
	}
...
//		mav.setViewName(path + ":sys/sys_010107_maintain");
	...
	public ModelAndView importExcel(ModelAndView mav, HttpServletRequest request, HttpServletResponse response,
			@RequestParam("importFile") MultipartFile file, @RequestParam("optionCode") String type) throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
	...
	public ModelAndView importAlarmDetail(ModelAndView mav, HttpServletRequest request, HttpServletResponse response,
			@RequestParam("importFile") MultipartFile file, @RequestParam("alarmCd") String alarmCd) throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
		Map result = new HashMap();
		try {
			XSSFWorkbook workbook = new XSSFWorkbook(file.getInputStream());
			int rs = service.insertAlarmDetail(workbook, alarmCd);
			if(rs>=0) {
				result.put("result", "true");
				String ms = "";
				if(rs == 0) {
					ms = "No valid alarm has been added.";
				}else if(rs == 1) {
					ms = "1 valid alarm has been added.";
				}else {
					ms =  rs+ " valid alarms have been added.";
				}
				result.put("msg", ms);
			}else {
				result.put("result", "false");
				result.put("msg", "Excel template is invalid!");
			}
		} catch (Exception e) {
			// TODO: handle exception
			//e.printStackTrace();
	...
	public void downloadFile(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (type.equals("001")) {
				...
				fileName = "AlarmListTemplate.xlsx";
			}
