...
@Controller("Code_0101Controller")
@RequestMapping("/sys/sys_0101")
public class Code_0101Controller  extends BaseController{
	...
	public ModelAndView doList(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
		 ...
		 * ModelAndView
		 */
	    mav.setViewName("sys/sys_0101");
		return mav;
	}
	
	@RequestMapping("/main") 
	public ModelAndView doListMaintenanceCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
...
/*	@RequestMapping("/addAlarmCode.ajax")
	...
	public @ResponseBody boolean saveDetailAlarm(ModelAndView mav, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Map<String, Object> session = (Map<String, Object>) parameter.get("session");
		String userUid = CommonUtil.getMapValue(session, "USER_UID", "");
		parameter.put("INS_USER", userUid);
		AjaxResult result = new AjaxResult();
	...
	@RequestMapping("/getPartDetailCd.ajax") // path = [popup,dialog,tab]
