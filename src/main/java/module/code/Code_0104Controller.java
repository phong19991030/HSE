...
@Controller("Code_0104Controller")
@RequestMapping("/sys/sys_0104")
public class Code_0104Controller  extends BaseController{
...
/*	@RequestMapping("/getMaintanceCode.ajax") 
	public @ResponseBody List getData03(ModelAndView mav, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
	...
	public ModelAndView getAllData(ModelAndView mav, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List list = service.getParentCommonCode(parameter);
	    /**
		 * ModelAndView
		 */
		mav.setViewName("jsonView"); 
...
//		String newCode = (String) parameter.get("COMM_CD");
	...
	public ModelAndView createCommon(ModelAndView mav, HttpServletRequest request, HttpServletResponse response,
		...
		Map parameter = ParameterUtil.getParameterMap(request);
		mav.setViewName(path + ":sys/sys_010401");
		return mav;
	}
	...
	public ModelAndView openDialogSelect(ModelAndView mav, HttpServletRequest request, HttpServletResponse response,
		...
		mav.setViewName(path + ":sys/sys_01010401");
...
//	}
	...
	public @ResponseBody String addCommonCode(ModelAndView mav, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Map<String, Object> parameter = ParameterUtil.getParameterMap(request);
