...
<jsp:include page="include/sub_header.jsp"></jsp:include>
	...
	<!-- cms-map-wrap3 -->
	<div class="cms-map-wrap cms-map-wrap2">
		<!--지도표시 영역-->
		<div id="map"></div>
		<!--//지도표시 영역-->
		...
		<!--click시 active-->
		<div id="infowindow-pop" class="popup-group">
			<div>
				...
				<li>
					...
					<div class="container-graph-wrap">
						<div id="container2" class="chart-container">
							<div class="no_data">
								<i class="fi fi-spinner fi-pulse loading" style="font-size: 50px; color: #4B5EE6; margin-right: 56%; margin-left: 44%; margin-bottom: 2%;"></i>
								<div class="no_data_text">Loding...</div>
								<!-- fi-spinner fi-propeller-1 fi-propeller-4-->
								<!-- margin-right: 50%; margin-left: 50%; #515150 -->
							</div>
						</div>
					</div>
				</li>
...
// 		var tt = Highcharts.chart('container2', {
// 			chart: {
// 				type: 'area'
// 			},
// 			xAxis: {
