...
<jsp:include page="include/sub_header.jsp"></jsp:include>
	...
	<div class="cms-map-wrap cms-map-wrap2  cms-map-wrap3">
		...
		<!--click시 active-->
		<div id="infowindow-pop" class="popup-turbine active">
			<div>
		...
		<script>
			...
			function initMap() {
				...
				var infoTemplate = 
					...
					' <div id="infowindow-pop" class="infowindow-turbine active">'
					+ ' <div>'
					+ ' <div class="wt-infowindow">'
					+ '	<em class="name">HS5500</em>'
					+ ' <span class="stick-graph">'
					+ ' 	<em>State</em>'
					+ ' 	<span class="bar-wrap">'
					+ ' 		<span class="bar-fill" style="width:80%;"></span>'
		        ...
		        marker = new google.maps.Marker({
		            position: new google.maps.LatLng(33.4377607, 126.6675584),
		            map: map,
		...
		<div class="cms-map-info-wrap-scroll">
			<ul class="cms-map-info-wrap-lst">
				<li class="wt-detail-info">
					<strong class="name">V47</strong>
					<ul>
						<li class="detail-info detail-info1">
							<strong><i class="xi-paper"></i><span>Turbine Name</span></strong>
							<span>V47</span>
						</li>
						<li class="detail-info detail-info2">
							<strong><i class="xi-user-address"></i><span>Manufacture</span></strong>
							<span>
						...
						<li class="detail-info detail-info4">
							...
							<span>9,380MW (40units)</span>
						</li>
						<li class="detail-info detail-info5">
	...
	<!-- layerpopup -->
	<div id="layerPopup" class="layer-popup-sensor active">
		<div class="layer-cont">
			<div class="tit-wrap">
				<strong class="heading9">Sensor Error</strong>
				
				<div class="sensor-error-cont">
					<strong class="heading10">20<span>Turbine OK</strong>
					<span class="cont">If the error the turbine has stopped with has reset before the turbine has delivered the alarm call to the QSL server, this error can occur. Can also occur on yaw errors</span>
				</div>
			</div>
	
			<a href="#none" class="layer-close">OK</a>
		</div>
	</div>
	<!-- //layerpopup -->
