...
<script type="text/javascript" src="${ctxPath}/script/common/comboboxInHeader.js"></script>
	...
	<div class="cms-map-wrap cms-map-wrap5">
		...
		<div id="infowindow-pop" class="popup-farm  warning-map-info">
			<div class="info">
				<span>
			...
			<div class="popup-farm-detail">
				<ul>
					<li>
						<strong class="tit">Energy production</strong>
						<strong class="detail-num"><span class="point point-txt">36</span>GW</strong>
					</li>
				</ul>
			</div>
