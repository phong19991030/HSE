				...
				<div class="system-left">
					...
					<div class="registration-form-lst-wrap">
						<ul class="registration-form-lst">
							<li>
								<span class="essential">Disposal Date</span>
							...
							<li>
								<span class="essential">Purchase Price</span>
								<div class="registration-write">
									<div class="input-group-wrapper">
										<div class="input-group">
							...
							<li>
								<span class="essential">Date of Use</span>
								<div class="registration-write">
									<div class="calendar-picker">
										<div class="calendar-wrap">
											<div class="input-group">
												<label for="dateofUse" class="sr-only"></label>
												<input type="text" id="dateofUse" name="dateofUse" value="">
												<button class="calendar-picker-btn">
													<i class="xi-calendar"></i>
												</button>
											</div>
