			...
			<div class="maintenance-form registration-form registration-form1">
				<div class="registration-form-lst-wrap maintenance-write-form">
					...
					<div class="registration-form-lst registration-form-lst-bg">
						<h3>Code list</h3>
						<button type="button"
							class="registration-search-btn btn-style btn-style1 popup-btn">Register</button>
					...
					<ul class="registration-form-lst right">
						<li class="head-area">
							...
							<span class="btn-wrap">
							<a href="#"	class="save-btn btn-style btn-style1">Save</a>
						...
						<li class="sub0"><span>Parent code</span>
							<div class="registration-write">
								<div class="input-group">
									<label for="name" class="sr-only">Name</label> <input type="text" id="" name="" value="" placeholder="D l Hub & Rotor"></div>
							</div>
						</li>
						<li class="sub"><span>Type</span>
							<div class="registration-write">
								<div class="select-box">
									<label for="selectType"></label>
										<select name="selectType"
										id="selectType" class="info-select">
							...
							<div class="registration-write">
								<div class="input-group">
									<label for="name" class="sr-only">Code</label> <input
										type="text" id="" name="" value="" placeholder="04">
								</div>
								<div class="input-group">
									<label for="name" class="sr-only">Code</label> <input
										type="text" id="" name="" value="" placeholder="Door & stair">
								</div>

							</div>
						</li>
						<li class="sub2"><span>Description</span>
							<div class="registration-write">
								<div class="input-group">
									<label for="name" class="sr-only">Description</label>
									<textarea>
The turbine has had an overspeed on the rotor. the error occurs it the turbine reach a set limit for how many rotations it may take per minut.

The turbine has had an overspeed on the rotor. the error occurs it the turbine reach a set limit for how many rotations it may take per minut. The turbine has had an overspeed on the rotor. the error occurs it the turbine reach a set limit for how many rotations it may take per minut. The turbine has had an overspeed 
on the rotor. the error occurs it the turbine reach a set limit for how many rotations it may take per minut. The turbine has had an overspeed on the rotor. 
the error occurs it the turbine 
									</textarea>
								</div>
							</div>
						</li>
...
<!-- layerPopup -->
<div id="layerPopup" class="registration">
		...
		<div class="layer-cont-sub">
			...
			<ul class="registration-write-wrap">
				...
				<li class="sub1"><span>Code</span>
					<div class="registration-write">
						<div class="input-group">
							<label for="name" class="sr-only">Code</label> <input type="text" id="" name="" value="">
						</div>
					</div>
				</li>
				<li class="sub2"><span>Name</span>
					<div class="registration-write">
						<div class="input-group">
							<label for="name" class="sr-only">Name</label> <input type="text" id="" name="" value="">
						</div>
					</div>
				</li>
