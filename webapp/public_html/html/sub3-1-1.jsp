...
<jsp:include page="include/sub_header.jsp"></jsp:include>
	...
	<div class="container">
		<div class="tit-wrap">
			<h2 class="heading3">
				<span class="txt">Parts</span>
			</h2>
			<ul class="location">
				<li>Asset Management</li>
				<li class="bold">Parts</li>
			</ul>
		</div>
		...
		<div class="base_grid_table btn-table">
			<table>
				<caption>Parts - No, Target WTG, Part Number, Category, Stock, Minimum Requirement, Inventory</caption>
				<colgroup>
					<col style="width:5%">
					<col style="width:30%">
					<col style="width:20%">
				...
				<tbody>
					<tr>
						...
						<td>004</td>
						<td>Main Cable</td>
						<td><strong class="point2 btn_point">1</strong></td>
						<td>3</td>
						<td>
							<a href="" class="inventory-btn">
								<i class="xi-box"></i>
							</a>
						</td>
					</tr>
					<tr>
						...
						<td>004</td>
						<td>Main Cable</td>
						<td><a href="#"><strong class="point2 btn_point">1</strong></a></td>
						<td>3</td>
						<td>
							<a href="" class="inventory-btn">
								<i class="xi-box"></i>
