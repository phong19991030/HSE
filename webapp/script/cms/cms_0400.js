...
function onSearch() {
	...
	var series_this_year = _cms.matchDataToSeriesOfBasicDateTime(data.SEARCH_YEAR, sampleSeries_this_year, 'TIMESTAMP_UTC', 'OR_RT');
	var series_last_year = _cms.matchDataToSeriesOfBasicDateTime(data.LAST_YEAR, sampleSeries_last_year, 'TIMESTAMP_UTC', 'OR_RT');
...
function drawChart(param, series, container_id) {
	...
	// chart option 생성 
	var options = _highchartOptions.cms_0400[container_id](param);
