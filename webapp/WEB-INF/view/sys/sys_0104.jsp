...
var drawgrid = function(formId,data){
	...
	$('#grid').setViewGrid({
		...
		type:'crud',
		pinHeader: false,  
		url: CTX + '/sys/sys_0104/getAllCode.ajax',
		param: formId,
		localData: mydata,
		data: mydata,  
...
// 			height: 570
		...
		colModels: 
		[
			{name:'Code', id :'CODE', width:120, align:'center'},
			...
			{name:'<spring:message code='sys.sys_0101.list.title.date' />', id :'INS_DT', width:80, align:'center'},	
			{name:'<spring:message code='sys.sys_0501.insertUser' />', id :'USER_ID', width:120, align:'center'},	
// 			{name:'User UID', id :'INS_USER', width:120, align:'center'},	
...
function importExel(){
	var type="CODE";
	var url = CTX+'/sys/sys_0104/importExel/form.tab?CODE_TYPE=001&TYPE='+type;
	var param = {};		
...
function showAlarm(rowId, target, e){
	...
	if(type=='Alarm code'){
		var url = CTX+'/sys/sys_0104/02?WT_ALARM_GR_ID='+code+'&GROUP_NM='+rowData['NAME'];
// 		var param = {};		
// 		var success = function(html){
// 				};
// 		var ajax = new AjaxAccess();
// 		ajax.loadingHTML(url, $('#detail-content'), param, success, "");
	...
	}else if(type=='Common code'){
		var type = "CODE"
		var url = CTX+'/sys/sys_0104/listdetailBasic/form.tab?CODE='+code+"&TYPE="+type;
		var param = {};		
		var success = function(html){
				};
		var ajax = new AjaxAccess();
		...
		var url = CTX+'/sys/sys_0104/listdetailMainten/form.tab';
		var param = {};		
		var success = function(html){
				};
		var ajax = new AjaxAccess();
		...
		var url = CTX+'/sys/sys_0104/listdetailPart/form.tab';
		var param = {};		
		var success = function(html){
				};
		var ajax = new AjaxAccess();
...
function addCode() {
		var url = CTX+'/sys/sys_0104/createCommon/form.tab';
		var param = {};		
		var success = function(html){
				};
		var ajax = new AjaxAccess();
