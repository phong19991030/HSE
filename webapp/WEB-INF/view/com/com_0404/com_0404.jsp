...
<div class="container">
	...
	<div class="tit-wrap">
		<h2 class="heading3">
            <span class="txt"><spring:message code="com.com_0404_lable.title" /></span> 
			<!-- <span class="version">V47</span> -->
		</h2>
		<ul class="location">
			<li><spring:message code="com.com_0404_lable.title" /></li>
			<li class="bold"><spring:message code="com.com_0404_lable.title" /></li>
		</ul>
	</div>
	<!--//타이틀 -->
...
<!-- 스크립트 -->	
<script src="${ctxPath}/script/com/com_0404.js?cachebuster="+ new Date().getTime()></script>
