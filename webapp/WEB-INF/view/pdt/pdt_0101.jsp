...
<div class="container prediction-form">
		...
		<div class="predict-tab">
		    ...
		    <label class="tab_item" for="tab-analyze">Analyze</label>
   			...
   			<div class="tab-content" id="forecast-content">
				...
				<div class="prediction-graph">
					<div class="tit-wrap">
						<strong class="heading6">Power forecast for the next 30 days</strong>
					</div>
				...
				<div class="base_grid_table table-wrap">
					...
					<table>
						<caption>Power forecast for the next 30 days</caption>
						<colgroup>
							<col style="width:20%">
							<col style="width:40%">
							<col style="width:40%">
						...
						<thead>
							<tr>
								...
								<th scope="col">Real - Active power (KWh)</th>
								<th scope="col">Predicted - Active power (KWh)</th>
							</tr>
						</thead>
					</table>
			...
			<div class="tab-content" id="analyze-content">
				...
				<div class="prediction-graph">
					<div class="tit-wrap">
						<strong class="heading6">Power forecast accuracy</strong>
					</div>
					<div class="graph-wrap" style="width: 100%; height: 380px; background: #f4f4f4;">
...
// 	$('.table-wrap').hide()
	$.ajax({
		  url: 'http://34.64.213.63:3105/public/pdt_0101/getData.ajax',
// 		  url: 'http://211.240.98.189:3105/public/pdt_0101/getData.ajax',
		  type: 'GET',
		  data: param,
...
// 							ERROR[i-index] =  HIS[i] == 0 && PRE[i] == 0? 0: HIS[i] == 0? 100: Math.abs(PRE[i] -  HIS[i])*100/HIS[i] > 100? 100: Number((Math.abs(PRE[i] -  HIS[i])*100/HIS[i]).toFixed(2));
...
// 		    },
	    ...
	    tooltip: {
	         ...
	         formatter: function(){
	            ...
	            '<span  style="font-weight: 300;">'+ this.series.name +  '</span>:<span style="margin-left: 5px; font-weight: 600;"> ' + this.y + ' KWh</span>' +
	                 '</div>';
	         }
	    },
	    series: [{
	...
	Highcharts.chart('container3', {
	    ...
	    tooltip: {
			followPointer: true,
	         ...
	         shared: true,
 	         formatter: function(){
	             return this.points[0].y? '<div style="color: #444; padding: 10px; opacity: 0.9; border-radius: 2px !important; min-width: 200px !important; background-color: #fff" class="tooltip"> ' +
...
function drawTable2(data) {
	...
	var avg =  powers.length > 0? Number(getAverage(powers).toFixed(2)) : 0;
	var str = '';
	str+= '<tr><th>Min</th><td>'+min+' KWh</td></tr>'
	+ '<tr><th>Max</th><td>'+max+' KWh</td></tr>'
	+ '<tr><th>Average</th><td>'+avg+' KWh</td></tr>';
