...
var popupDrawgrid = function(formId,data){
	...
	$('#popupGrid').setViewGrid({id:'popupGrid',type:'crud',
		...
		colModels : [	              
     	   	{name:'프로그램필드명', id :'COMM_NM', attrType: 'text', width:100}, 
   	   		{name:'프로그램필드코드명', id :'COMM_CD', attrType: 'text', width:200, align:'left'},
   	   		{name:'경로' ,id :'USE_YN',  width:200, align:'left'} 
   	   	],
...
<div id="popup_wrapper">
	...
	<form:form action="${ctxPath}/stm/stm_0202/save02.ajax"  id="saveForm" data-func="saveAjax"  data-callback="callbackFunc" >    <%-- data-msg="SAVE" --%>
