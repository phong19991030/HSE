...
<main id="content" class="environ-page">
  <div class="container">
    <section class="hdSection">
      ...
      <div class="tit-wrap">
        <div class="tit-left">
          <h1 class="heading1">유해위험물질 운영 관리 상세</h1>
        </div>
      </div>
      <!-- //tit-wrap -->
    </section>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colspan="5">${DATA.DATE_OF_ISSUE}</td>
                  </tr>
                  <tr>
...
<script src="${ctxPath}/script/res/res_000302.js"></script>
