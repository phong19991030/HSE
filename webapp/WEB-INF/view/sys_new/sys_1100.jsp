...
.tag.PART {background: #455eee !important;}
.tag.TOOL {background: #636363 !important;}
.tag.PPE {background: #F79838 !important;}

.code-name.PART {color:#455eee !important;}
.code-name.TOOL {color:#636363 !important;}
.code-name.PPE {color:#F79838!important;}
</style>
...
<div class="container">
	...
	<div class="system-detail-wrap">
		<div class="system-left" style="width: 100%; border-right: none; padding-right: 0;">
			...
			<div class="tit-wrap">
				<h2 class="heading3">
					<span class="txt">Com Code</span>
				</h2>
				<ul class="location">
					<li>SYSTEM</li>
					<li>Code management</li>
					<li class="bold">Com Code</li>
				</ul>
			</div>
			<!-- //타이틀 -->
			...
			<div class="maintenance-form registration-form registration-form1">
				<div class="registration-form-lst-wrap maintenance-write-form">
					...
					<div class="registration-form-lst registration-form-lst-bg">
						<h3>Code list</h3>
						<!-- 셀렉트 박스 -->
						<!-- <div class="select-box" style="display: inline-grid; width: 25%; margin-left: 20px; background: #fff">
							<label for="SEARCH_TYPE"></label>
							<select id="SEARCH_TYPE" class="info-select">
...
<!-- 								</li> -->
					...
					<ul id="DETAIL-FORM" class="registration-form-lst right" style="display:none;">
						...
						<li class="tit-area">
							...
							<strong class="tit-sub">
								<em id="COMM_CD" class="num"></em>
								<span id="COMM_NM" class="code-name"></span>
							</strong>
						</li>
					...
					<ul id="MODIFY-FORM" class="registration-form-lst right" style="display:none;">
						...
						<li class="sub0 tit-area">
							...
							<strong class="tit-sub">
								<em id="UP_COMM_CD" class="num"></em>
								<span id="UP_COMM_NM" class="code-name"></span>
							</strong>
						</li>
						<li class="sub1">
							...
							<div class="registration-write">
								<div class="input-group">
									<label for="COMM_CD" class="sr-only"></label>
									<input type="text" id="COMM_CD" validation-check="required" maxlength="20" autocomplete="off">
								</div>
								<div class="input-group">
									<label for="COMM_NM" class="sr-only"></label>
									<input type="text" id="COMM_NM" validation-check="required" maxlength="50" autocomplete="off">
								</div>
							</div>
						</li>
						...
						<li class="sub2">
							...
							<div class="registration-write">
								<div class="input-group" style="height:14rem;">
...
<!-- 스크립트 -->
<script src="${ctxPath}/script/sys/sys_1100.js"></script>
