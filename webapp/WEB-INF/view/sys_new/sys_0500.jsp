		...
		<div class="search-wrapper" style="width:647px;">
			...
			<div class="search-detail">
				<ul class="detail-search-lst">
					<li>
						<span class="detail-search-keyword">Organization</span>
						<div class="input-group">
					...
					<li>
						<span class="detail-search-keyword">Classification</span>
						<div class="select-box bul-none input-group">
							<label for="criteriaB" class="mark" >:: Select ::</label>
							<select id="SEARCH_CRITERIA_B" name="criteriaB" class="info-select">
								<option value="" selected>:: Select ::</option>
								<option value="1">Operator</option>
								<option value="2">Manufacturer</option>
								<option value="3">ISP</option>
								<option value="4">Consulting firm</option>
							</select>
						</div>
					</li>
				</ul>
...
<!-- 스크립트 -->	
<script src="${ctxPath}/script/sys/sys_0500.js"></script>
