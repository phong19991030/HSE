...
<style>
td a {color:green;}
.select-box label.mark1:before {content: '' !important;}
.select-box label.mark2:before {content: '' !important;}
.select-box label.mark3:before {content: '' !important;}
.select-box label.mark4:before {content: '' !important;}
		...
		<div class="search-wrapper" style="width:647px;">
			...
			<div class="search-detail">
				<ul class="detail-search-lst">
					...
					<li>
						<span class="detail-search-keyword">Alarm Name</span>
						<div class="input-group">
...
<!-- 스크립트 -->	
<script src="${ctxPath}/script/sys/sys_0900.js"></script>
