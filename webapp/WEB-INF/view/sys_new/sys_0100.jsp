...
<div class="container">
	...
	<div class="tit-wrap">
		<h2 class="heading3">
			<span class="txt">Farm Management</span>
		...
		<div class="search-wrapper" style="width:647px;">
			...
			<div class="search-detail">
				<ul class="detail-search-lst">
					<li>
						<span class="detail-search-keyword">Wind farm</span>
						<div class="input-group">
							<label for="criteriaA" class="sr-only">Wind farm name</label>
							<input type="text" id="SEARCH_CRITERIA_A" name="criteriaA" value="" maxlength="50">
						</div>
					</li>
					<li>
						<span class="detail-search-keyword">Operator</span>
						<div class="input-group">
							<label for="criteriaB" class="sr-only">Operator name</label>
		...
		<table>
			...
			<thead>
				<tr>
					...
					<th scope="col">Install Capacity(MW)</th>
					<th scope="col">WTG</th>
...
<!-- 스크립트 -->	
<script src="${ctxPath}/script/sys/sys_0100.js"></script>
