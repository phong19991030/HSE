	...
	<div class="system-left">
		...
		<div class="registration-form registration-form1">
		  ...
		  <!-- 왼쪽 등록폼 -->
		    <ul class="registration-form-lst">
		      <li>
		        <span><spring:message code="doc.doc_0100_lable.group" /><span class="red"> *</span></span>
		        <div class="registration-write">
		          <div class="input-group">
		            <label for="DOC_GROUP" class="sr-only"><spring:message code="doc.doc_0100_lable.group" /></label>
		            <input type="text" id="DOC_GROUP" validation-check="required" maxlength="20">
		          </div>
		        </div>
		      </li>
		      <li>
		        <span><spring:message code="doc.doc_0100_lable.name" /><span class="red"> *</span></span>
		        <div class="registration-write">
		          <div class="input-group">
		            <label for="DOC_NAME" class="sr-only"><spring:message code="doc.doc_0100_lable.name" /></label>
	  ...
	  <div class="system-right">
	    <div class="btns" style="position:fixed; width:12%;">
	    	...
	    	<a href="javascript:void(0)" id="DOWLOAD_FILE" class="btn-style btn-style1 hidden"><spring:message code="doc.doc_0100_lable.dowloadFile" /></a> 
...
<!-- 스크립트 -->	
<script src="${ctxPath}/script/sys/doc_0101.js?cachebuster="+ new Date().getTime()></script>
